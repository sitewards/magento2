...
/**
 * Heidelpay Santander Invoice payment method
 *
 * This is the payment class for heidelpay Santander Invoice
 *
 ...
 *
 * @package heidelpay\magento2\payment-methods\santander-invoice
 */
class HeidelpaySantanderInvoicePaymentMethod extends HeidelpayAbstractPaymentMethod
{
    /**
     * Payment Code
     * @var string
     */
    protected $_code = 'hgwsantanderiv';
     ...
     * @param \Heidelpay\PhpApi\PaymentMethods\SantanderInvoicePaymentMethod $santanderInvoicePaymentMethod
    ...
    public function __construct(
        ...
        \Heidelpay\PhpApi\PaymentMethods\SantanderInvoicePaymentMethod $santanderInvoicePaymentMethod,
        ...
        $this->_heidelpayPaymentMethod = $santanderInvoicePaymentMethod;
    }
